...
**Smart Contract:** [`zk_pay_proofs_privacy_v23.aleo`](https://testnet.explorer.provable.com/program/zk_pay_proofs_privacy_v23.aleo)  
...
The on-chain protocol `zk_pay_proofs_privacy_v23.aleo` enforces:
...
```env
VITE_PROGRAM_ID=zk_pay_proofs_privacy_v23.aleo
...
The core contract `zk_pay_proofs_privacy_v23.aleo` is deployed on Aleo Testnet.

**Explorer Link:** [https://testnet.explorer.provable.com/program/zk_pay_proofs_privacy_v23.aleo](https://testnet.explorer.provable.com/program/zk_pay_proofs_privacy_v23.aleo)
