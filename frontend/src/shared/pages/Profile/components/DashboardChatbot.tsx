...
export const DashboardChatbot: React.FC<DashboardChatbotProps> = ({
    ...
    }, [balances, merchantStats, invoices, mainMerchantReceipts, burnerMerchantReceipts, payerReceipts]);
