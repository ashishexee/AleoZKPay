            ...
            <GlassCard className="p-8 md:p-10">
                ...
                <div className="space-y-4 mb-8">
                    <div className="p-5 bg-white/[0.02] border border-white/[0.06] rounded-xl">
                        ...
                        <p className="text-gray-400 text-sm">Run our interactive CLI wizard: <code className="text-white bg-white/5 py-0.5 px-1.5 rounded">npx @nullpay/cli@latest sdk onboard</code>. It handles generating salts, submitting to the Aleo relayer, resolving the invoice hashes on the network, and writing the final <code className="text-white bg-white/5 py-0.5 px-1.5 rounded">nullpay.json</code> file for you. That invoice-creation step is relayed by NullPay, so the merchant does not need to manually broadcast the setup transaction.</p>
                    </div>
                    <div className="p-5 bg-white/[0.02] border border-white/[0.06] rounded-xl">
